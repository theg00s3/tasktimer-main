...
class Statistics extends Component {
  ...
  renderAuthorizedContent() {
    ...
    pomodori = pomodori || []
    const fullPomodoriCount = PomodoroUtils.fullPomodoriCount(pomodori)
    const fullPomodoriHours = PomodoroUtils.fullPomodoriHours(pomodori)
    const partialPomodoriCount = PomodoroUtils.partialPomodoriCount(pomodori)
    const partialPomodoriHours = PomodoroUtils.partialPomodoriHours(pomodori)
    ...
    if( pomodori.length > 0 ) {
      content = <div>
                  <h2>{fullPomodoriCount} pomodori &tilde; {fullPomodoriHours}h</h2>
                  <p>(out of {partialPomodoriCount} pomodori &tilde; {partialPomodoriHours}h)</p>
                  <div className="ovs">
